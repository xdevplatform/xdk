...
import requests
import time
from .models import 2_usage_tweets_response
...
class UsageClient:
    ...
    def 2_usage_tweets(self, 
        ...
        Returns:
            2_usage_tweets_response: Response data
        """
        ...
        return 2_usage_tweets_response.model_validate(response_data)
