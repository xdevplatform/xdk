...
import requests
import time
from .models import 2_spaces_id_tweets_response, 2_spaces_by_creator_ids_response, 2_spaces_response, 2_spaces_id_buyers_response, 2_spaces_search_response, 2_spaces_id_response
...
class SpacesClient:
    ...
    def 2_spaces_by_creator_ids(self, 
