...
import requests
import time
from .models import 2_users_id_bookmarks_folders_response, 2_users_id_bookmarks_folders_folder_id_response, 2_users_id_bookmarks_response, 2_users_id_bookmarks_request, 2_users_id_bookmarks_response, 2_users_id_bookmarks_tweet_id_response
...
class BookmarksClient:
    ...
    def 2_users_id_bookmarks_folders(self, 
    ...
    def 2_users_id_bookmarks_folders_folder_id(self, 
    ...
    def 2_users_id_bookmarks_tweet_id(self, 
