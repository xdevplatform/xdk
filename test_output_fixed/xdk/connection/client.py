...
import requests
import time
from .models import 2_connections_all_response
...
class ConnectionClient:
    ...
    def 2_connections_all(self, 
        ...
        Returns:
            2_connections_all_response: Response data
        """
        ...
        return 2_connections_all_response.model_validate(response_data)
