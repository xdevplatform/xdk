...
import requests
import time
from .models import 2_notes_search_posts_eligible_for_notes_response, 2_notes_request, 2_notes_response, 2_notes_search_notes_written_response, 2_notes_id_response
...
class Community_NotesClient:
    ...
    def 2_notes_search_posts_eligible_for_notes(self, 
    ...
    def 2_notes_search_notes_written(self, 
