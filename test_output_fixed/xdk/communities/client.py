...
import requests
import time
from .models import 2_communities_id_response, 2_communities_request, 2_communities_response, 2_communities_search_response, 2_communitites_id_name_response, 2_users_id_pinned_communities_request, 2_users_id_pinned_communities_response, 2_users_id_pinned_communities_request, 2_users_id_pinned_communities_response
...
class CommunitiesClient:
    ...
    def 2_communitites_id_name(self, 
    ...
    def 2_users_id_pinned_communities(self, 
