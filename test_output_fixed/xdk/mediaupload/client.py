...
import requests
import time
from .models import 2_media_metadata_request, 2_media_metadata_response, 2_media_upload_response, 2_media_upload_request, 2_media_upload_response, 2_media_upload_initialize_request, 2_media_upload_initialize_response, 2_media_upload_id_append_request, 2_media_upload_id_append_response, 2_media_subtitles_request, 2_media_subtitles_response, 2_media_subtitles_request, 2_media_subtitles_response, 2_media_upload_id_finalize_response
...
class MediaUploadClient:
    ...
    def 2_media_upload_initialize(self, 
    ...
    def 2_media_upload_id_append(self, 
    ...
    def 2_media_upload_id_finalize(self, 
