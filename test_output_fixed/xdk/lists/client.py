...
import requests
import time
from .models import 2_lists_id_response, 2_lists_id_request, 2_lists_id_response, 2_lists_id_response, 2_users_id_pinned_lists_list_id_response, 2_users_id_pinned_lists_response, 2_users_id_pinned_lists_request, 2_users_id_pinned_lists_response, 2_users_id_owned_lists_response, 2_lists_id_members_request, 2_lists_id_members_response, 2_users_id_followed_lists_list_id_response, 2_lists_id_members_user_id_response, 2_lists_request, 2_lists_response, 2_users_id_list_memberships_response, 2_users_id_followed_lists_response, 2_users_id_followed_lists_request, 2_users_id_followed_lists_response
...
class ListsClient:
    ...
    def 2_users_id_pinned_lists_list_id(self, 
    ...
    def 2_users_id_pinned_lists(self, 
    ...
    def 2_users_id_owned_lists(self, 
    ...
    def 2_users_id_followed_lists_list_id(self, 
    ...
    def 2_lists_id_members_user_id(self, 
    ...
    def 2_users_id_list_memberships(self, 
    ...
    def 2_users_id_followed_lists(self, 
