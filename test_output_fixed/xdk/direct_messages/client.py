...
import requests
import time
from .models import 2_dm_conversations_with_participant_id_dm_events_response, 2_dm_conversations_with_participant_id_messages_request, 2_dm_conversations_with_participant_id_messages_response, 2_dm_conversations_request, 2_dm_conversations_response, 2_dm_conversations_id_dm_events_response, 2_dm_events_response, 2_dm_conversations_dm_conversation_id_messages_request, 2_dm_conversations_dm_conversation_id_messages_response, 2_dm_events_event_id_response, 2_dm_events_event_id_response
...
class Direct_MessagesClient:
    ...
    def 2_dm_conversations_with_participant_id_dm_events(self, 
    ...
    ) -> 2_dm_conversations_with_participant_id_dm_events_response:
        """
        ...
        Returns:
            2_dm_conversations_with_participant_id_dm_events_response: Response data
        """
        ...
        return 2_dm_conversations_with_participant_id_dm_events_response.model_validate(response_data)
        
    
    def 2_dm_conversations_with_participant_id_messages(self, 
        ...
        body: Optional[2_dm_conversations_with_participant_id_messages_request] = None,
        ...
        Returns:
            2_dm_conversations_with_participant_id_messages_response: Response data
        """
        ...
        return 2_dm_conversations_with_participant_id_messages_response.model_validate(response_data)
        
    
    def 2_dm_conversations(self, 
        ...
        body: Optional[2_dm_conversations_request] = None,
        ...
        Returns:
            2_dm_conversations_response: Response data
        """
        ...
        return 2_dm_conversations_response.model_validate(response_data)
        
    
    def 2_dm_conversations_id_dm_events(self, 
    ...
    ) -> 2_dm_conversations_id_dm_events_response:
        """
        Get DM events for a DM conversation
        ...
        Returns:
            2_dm_conversations_id_dm_events_response: Response data
        """
        ...
        return 2_dm_conversations_id_dm_events_response.model_validate(response_data)
        
    
    def 2_dm_events(self, 
        ...
        Returns:
            2_dm_events_response: Response data
        """
        ...
        return 2_dm_events_response.model_validate(response_data)
        
    
    def 2_dm_conversations_dm_conversation_id_messages(self, 
        ...
        body: Optional[2_dm_conversations_dm_conversation_id_messages_request] = None,
        ...
        Returns:
            2_dm_conversations_dm_conversation_id_messages_response: Response data
        """
        ...
        return 2_dm_conversations_dm_conversation_id_messages_response.model_validate(response_data)
        
    
    def 2_dm_events_event_id(self, 
        ...
        Returns:
            2_dm_events_event_id_response: Response data
        """
        ...
        return 2_dm_events_event_id_response.model_validate(response_data)
