...
try {
  ...
  execSync('npx typedoc --tsconfig tsconfig.docs.json --out docs --name "X API SDK v2.152" --readme README.md --theme default --includeVersion true --excludePrivate true --excludeProtected true --excludeExternals true --excludeInternal true --searchInComments true --cleanOutputDir true', { stdio: 'inherit' });
