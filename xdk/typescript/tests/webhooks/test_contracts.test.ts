...
describe('WebhooksClient Contracts', () => {
  let client: Client;
  ...
  it('should have correct request structure for validate', async () => {
    ...
    try {
      ...
      // Call the method
      const method = (webhooksClient as any)['validate'];
      ...
      const expectedPath = '/2/webhooks/{webhook_id}';
  ...
  it('should handle required parameters correctly for validate', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
  ...
  it('should validate response structure for validate', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
  ...
  it('should have correct request structure for delete', async () => {
    ...
    try {
      ...
      // Call the method
      const method = (webhooksClient as any)['delete'];
      const result = await method.apply(webhooksClient, [...requiredArgs, options]);
  ...
  it('should have correct request structure for getStreamLinks', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
    ...
    try {
      ...
      // Check URL structure - path parameters are replaced in the URL
      const expectedPath = '/2/tweets/search/webhooks';
      // Path parameters are replaced with actual values, so check for the base path structure
      const basePath = expectedPath.split('{')[0];
      expect(url).toContain(basePath);
  ...
  it('should handle required parameters correctly for getStreamLinks', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
  ...
  it('should validate response structure for getStreamLinks', async () => {
    // Mock validateAuthentication to bypass auth checks (like Python mocks session)
    const originalValidateAuth = client.validateAuthentication;
    client.validateAuthentication = jest.fn();
