...
export class UsersClient {
  ...
  async getFollowers(
    ...
    const path = `/2/users/{id}/followers`;
  ...
  async getListsFollowers(
    ...
    const path = `/2/lists/{id}/followers`;
  ...
  async getFollowing(
    ...
    const path = `/2/users/{id}/following`;
  ...
  async getPostsLiking(
    ...
    const path = `/2/tweets/{id}/liking_users`;
  ...
  async getPostsRepostedBy(
    ...
    const path = `/2/tweets/{id}/retweeted_by`;
  ...
  async getBlocking(
    ...
    const path = `/2/users/{id}/blocking`;
  ...
  async blockDms(
    ...
    const path = `/2/users/{id}/dm/block`;
  ...
  async unblockDms(
    ...
    const path = `/2/users/{id}/dm/unblock`;
