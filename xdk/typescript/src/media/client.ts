...
export class MediaClient {
     ...
     * @returns MediaCreateMetadataResponse Response data
     */
     ...
     * @param mediaAnalyticsfields A comma separated list of MediaAnalytics fields to display.



     * @returns MediaGetAnalyticsResponse Response data
     */
    ...
    async getAnalytics(
        ...
        if (mediaAnalyticsfields !== undefined) {
            params.set("media_analytics.fields", mediaAnalyticsfields.map(String).join(","));
        }
        const headers = new Headers();
        // Make the request
        const response = await (this.client.oauth2Session || fetch)(url + (params.toString() ? `?${params.toString()}` : ""), {
     ...
     * @returns MediaGetByMediaKeyResponse Response data
     */
     ...
     * @returns MediaCreateSubtitlesResponse Response data
     */
     ...
     * @returns MediaDeleteSubtitlesResponse Response data
     */
     ...
     * @returns MediaInitializeUploadResponse Response data
     */
     ...
     * @returns MediaFinalizeUploadResponse Response data
     */
     ...
     * @returns MediaGetUploadStatusResponse Response data
     */
     ...
     * @returns MediaUploadResponse Response data
     */
     ...
     * @returns MediaGetByMediaKeysResponse Response data
     */
     ...
     * @returns MediaAppendUploadResponse Response data
     */
