 ...
 */
export interface PostsGetUsersTimelineStreamingOptions {
 ...
 */
export interface PostsGetUsersStreamingOptions {
  /** The minimum Post ID to be included in the result set. This parameter takes precedence over start_time if both are specified. */
  sinceId?: string;
 ...
 */
export interface PostsGetUsersMentionsStreamingOptions {
  /** The minimum Post ID to be included in the result set. This parameter takes precedence over start_time if both are specified. */
  sinceId?: string;
 ...
 */
export interface PostsGetUsersLikedStreamingOptions {
  /** The maximum number of results. */
  maxResults?: number;
 ...
 */
export interface PostsRepostStreamingOptions {
  /** Request body */
  body?: any;
 ...
 */
export interface PostsLikeStreamingOptions {
  /** Request body */
  body?: any;
 ...
 */
export interface PostsGetListsStreamingOptions {
  /** The maximum number of results. */
  maxResults?: number;
...
export class PostsClient {
  ...
  async unrepost(
    ...
    this.client.validateAuthentication(requiredAuthTypes, 'unrepost');
  ...
  async getUsersTimeline(
    id: string,
    options: PostsGetUsersTimelineStreamingOptions = {}
    ...
    this.client.validateAuthentication(requiredAuthTypes, 'getUsersTimeline');
  ...
  async getUsers(
    id: string,
    options: PostsGetUsersStreamingOptions = {}
  ...
  async unlike(id: string, tweetId: string): Promise<PostsUnlikeResponse> {
    ...
    this.client.validateAuthentication(requiredAuthTypes, 'unlike');
  ...
  async getUsersMentions(
    id: string,
    options: PostsGetUsersMentionsStreamingOptions = {}
    ...
    this.client.validateAuthentication(requiredAuthTypes, 'getUsersMentions');
  ...
  async getUsersLiked(
    id: string,
    options: PostsGetUsersLikedStreamingOptions = {}
    ...
    this.client.validateAuthentication(requiredAuthTypes, 'getUsersLiked');
  ...
  async repost(
    id: string,
    options: PostsRepostStreamingOptions = {}
    ...
    this.client.validateAuthentication(requiredAuthTypes, 'repost');
  ...
  async like(
    id: string,
    options: PostsLikeStreamingOptions = {}
    ...
    this.client.validateAuthentication(requiredAuthTypes, 'like');
  ...
  async getLists(
    id: string,
    options: PostsGetListsStreamingOptions = {}
    ...
    this.client.validateAuthentication(requiredAuthTypes, 'getLists');
