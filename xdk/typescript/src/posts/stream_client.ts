 ...
 */
export interface PostsCreateStreamingOptions {
  /** Additional request options */
  requestOptions?: RequestOptions;
  /** Additional headers */
  headers?: Record<string, string>;
 ...
 */
export interface PostsDeleteStreamingOptions {
  /** Additional request options */
  requestOptions?: RequestOptions;
  /** Additional headers */
  headers?: Record<string, string>;
...
export class PostsClient {
  ...
  async create(
    body: any,
    options: PostsCreateStreamingOptions = {}
  ...
  async delete(
    id: string,
    options: PostsDeleteStreamingOptions = {}
