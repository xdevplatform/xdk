...
var Client = class {
  ...
  constructor(config) {
    ...
    const defaultHeaders = {
      "User-Agent": "xdk-typescript/0.2.0-beta",
      "Content-Type": "application/json",
...
export { models_exports13 as AccountActivity, AccountActivityClient, models_exports11 as Activity, ActivityClient, ApiError, Client, models_exports5 as Communities, CommunitiesClient, models_exports10 as CommunityNotes, CommunityNotesClient, models_exports4 as Compliance, ComplianceClient, models_exports17 as Connections, ConnectionsClient, CryptoUtils, models_exports as DirectMessages, DirectMessagesClient, EventPaginator, models_exports15 as General, GeneralClient, HttpClient, models_exports8 as Lists, ListsClient, models_exports2 as Media, MediaClient, models_exports9 as News, NewsClient, OAuth1, OAuth2, Paginator, PostPaginator, models_exports7 as Posts, PostsClient, schemas_exports as Schemas, models_exports12 as Spaces, SpacesClient, models_exports18 as Stream, StreamClient, models_exports16 as Trends, TrendsClient, models_exports14 as Usage, UsageClient, UserPaginator, models_exports6 as Users, UsersClient, models_exports3 as Webhooks, WebhooksClient, generateCodeChallenge, generateCodeVerifier, generateNonce, generateTimestamp, hmacSha1, httpClient };
