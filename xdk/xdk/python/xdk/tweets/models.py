...
class StreampostsfirehosekoResponseData(BaseModel):
    ...
    non_public_metrics: Optional["StreampostsfirehosekoResponseDataNonPublicMetrics"] = None
    ...
    promoted_metrics: Optional["StreampostsfirehosekoResponseDataPromotedMetrics"] = None
...
class CreatepostsRequest(BaseModel):
    ...
    media: Optional["CreatepostsRequestMedia"] =Field(description="Media information being attached to created Tweet. This is mutually exclusive from Quote Tweet Id, Poll, and Card URI.",default_factory=dict)
    nullcast: Optional[bool] =None
    poll: Optional["CreatepostsRequestPoll"] =Field(description="Poll options for a Tweet with a poll. This is mutually exclusive from Media, Quote Tweet Id, and Card URI.",default_factory=dict)
    quote_tweet_id: Optional[str] =None
    reply: Optional["CreatepostsRequestReply"] =Field(description="Tweet information of the Tweet being replied to.",default_factory=dict)
    reply_settings: Optional[str] =None
...
class StreampostsfirehosejaResponseData(BaseModel):
    ...
    in_reply_to_user_id:Optional[str] =None
    lang:Optional[str] =None
    non_public_metrics: Optional["StreampostsfirehosejaResponseDataNonPublicMetrics"] = None
    ...
    possibly_sensitive:Optional[bool] =None
    promoted_metrics: Optional["StreampostsfirehosejaResponseDataPromotedMetrics"] = None
...
class StreampostsfirehoseenResponseData(BaseModel):
    ...
    in_reply_to_user_id:Optional[str] =None
    lang:Optional[str] =None
    non_public_metrics: Optional["StreampostsfirehoseenResponseDataNonPublicMetrics"] = None
    ...
    possibly_sensitive:Optional[bool] =None
    promoted_metrics: Optional["StreampostsfirehoseenResponseDataPromotedMetrics"] = None
...
class GetrulecountsResponseData(BaseModel):
    ...
    client_app_rules_count: Optional["GetrulecountsResponseDataClientAppRulesCount"] = None
...
class StreampostsfirehoseResponseData(BaseModel):
    ...
    in_reply_to_user_id:Optional[str] =None
    lang:Optional[str] =None
    non_public_metrics: Optional["StreampostsfirehoseResponseDataNonPublicMetrics"] = None
...
class StreampostsfirehoseptResponseData(BaseModel):
    ...
    in_reply_to_user_id:Optional[str] =None
    lang:Optional[str] =None
    non_public_metrics: Optional["StreampostsfirehoseptResponseDataNonPublicMetrics"] = None
    ...
    possibly_sensitive:Optional[bool] =None
    promoted_metrics: Optional["StreampostsfirehoseptResponseDataPromotedMetrics"] = None
...
class Streampostssample10ResponseData(BaseModel):
    ...
    in_reply_to_user_id:Optional[str] =None
    lang:Optional[str] =None
    non_public_metrics: Optional["Streampostssample10ResponseDataNonPublicMetrics"] = None
...
class UpdaterulesRequest(BaseModel):
    ...
    delete: Optional[Dict[str, Any]] = Field(default=None, description="IDs and values of all deleted user-specified stream filtering rules.")
