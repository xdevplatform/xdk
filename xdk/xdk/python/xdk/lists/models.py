...
class CreatelistsResponse(BaseModel):
    ...
    data: Optional["CreatelistsResponseData"] =Field(description="A X List is a curated group of accounts.",default_factory=dict)
...
class GetlistsbyidResponse(BaseModel):
    ...
    data: Optional["GetlistsbyidResponseData"] =Field(description="A X List is a curated group of accounts.",default_factory=dict)
    errors: Optional[List] =None
