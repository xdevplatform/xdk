...
class CreatemediametadataRequestMetadata(BaseModel):
    ...
    allow_download_status: Optional["CreatemediametadataRequestMetadataAllowDownloadStatus"] = None
    ...
    content_expiration: Optional["CreatemediametadataRequestMetadataContentExpiration"] = None
    domain_restrictions: Optional["CreatemediametadataRequestMetadataDomainRestrictions"] = None
    found_media_origin: Optional["CreatemediametadataRequestMetadataFoundMediaOrigin"] = None
    ...
    sensitive_media_warning: Optional["CreatemediametadataRequestMetadataSensitiveMediaWarning"] = None
...
class CreatemediametadataResponseData(BaseModel):
    ...
    associated_metadata: Optional["CreatemediametadataResponseDataAssociatedMetadata"] = None
    id:Optional[str] =None
...
class CreatemediametadataResponseDataAssociatedMetadata(BaseModel):
    ...
    allow_download_status: Optional["CreatemediametadataResponseDataAssociatedMetadataAllowDownloadStatus"] = None
    alt_text: Optional["CreatemediametadataResponseDataAssociatedMetadataAltText"] = None
    audience_policy: Optional["CreatemediametadataResponseDataAssociatedMetadataAudiencePolicy"] = None
    content_expiration: Optional["CreatemediametadataResponseDataAssociatedMetadataContentExpiration"] = None
    domain_restrictions: Optional["CreatemediametadataResponseDataAssociatedMetadataDomainRestrictions"] = None
    found_media_origin: Optional["CreatemediametadataResponseDataAssociatedMetadataFoundMediaOrigin"] = None
    geo_restrictions:Any =None
    management_info: Optional["CreatemediametadataResponseDataAssociatedMetadataManagementInfo"] = None
    preview_image: Optional["CreatemediametadataResponseDataAssociatedMetadataPreviewImage"] = None
    sensitive_media_warning: Optional["CreatemediametadataResponseDataAssociatedMetadataSensitiveMediaWarning"] = None
    shared_info: Optional["CreatemediametadataResponseDataAssociatedMetadataSharedInfo"] = None
    sticker_info: Optional["CreatemediametadataResponseDataAssociatedMetadataStickerInfo"] = None
    upload_source: Optional["CreatemediametadataResponseDataAssociatedMetadataUploadSource"] = None
...
class CreatemediametadataResponseDataAssociatedMetadataPreviewImage(BaseModel):
    ...
    media_key: Optional["CreatemediametadataResponseDataAssociatedMetadataPreviewImageMediaKey"] = None
