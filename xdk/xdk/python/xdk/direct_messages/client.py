...
class DirectMessagesClient:
    ...
    def get_dm_events(self, 
        ...
        Returns:
            GetdmeventsResponse: Response data
        """
        ...
        return GetdmeventsResponse.model_validate(response_data)
    ...
    def get_dm_events_by_id(self, 
        ...
        Returns:
            GetdmeventsbyidResponse: Response data
        """
        ...
        return GetdmeventsbyidResponse.model_validate(response_data)
