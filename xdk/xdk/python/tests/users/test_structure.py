...
class TestUsersStructure:
    ...
    def test_get_posts_liking_users_exists(self):
        ...
        assert method is not None, f"Method get_posts_liking_users does not exist on UsersClient"
        ...
        assert len(params) >= 1, f"get_posts_liking_users should have at least 'self' parameter"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_posts_liking_users"
    ...
    def test_block_users_dms_exists(self):
        ...
        assert method is not None, f"Method block_users_dms does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"block_users_dms should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from block_users_dms"
    ...
    def test_unfollow_user_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from unfollow_user"
    ...
    def test_get_users_by_ids_exists(self):
        ...
        assert method is not None, f"Method get_users_by_ids does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_by_ids should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_by_ids"
    ...
    def test_get_users_by_usernames_exists(self):
        ...
        assert method is not None, f"Method get_users_by_usernames does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_by_usernames should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_by_usernames"
    ...
    def test_get_posts_reposted_by_exists(self):
        ...
        assert method is not None, f"Method get_posts_reposted_by does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_posts_reposted_by should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_posts_reposted_by"
    ...
    def test_search_users_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from search_users"
    ...
    def test_get_users_blocking_exists(self):
        ...
        assert method is not None, f"Method get_users_blocking does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_blocking should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_blocking"
    ...
    def test_get_users_by_id_exists(self):
        ...
        assert method is not None, f"Method get_users_by_id does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_by_id should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_by_id"
    ...
    def test_get_my_user_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_my_user"
    ...
    def test_get_users_following_exists(self):
        ...
        assert method is not None, f"Method get_users_following does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_following should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_following"
    ...
    def test_get_lists_followers_exists(self):
        ...
        assert method is not None, f"Method get_lists_followers does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_lists_followers should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_lists_followers"
    ...
    def test_get_lists_members_exists(self):
        ...
        assert method is not None, f"Method get_lists_members does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_lists_members should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_lists_members"
    ...
    def test_get_users_followers_exists(self):
        ...
        assert method is not None, f"Method get_users_followers does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_followers should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_followers"
    ...
    def test_get_users_reposts_of_me_exists(self):
        ...
        assert method is not None, f"Method get_users_reposts_of_me does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_reposts_of_me should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_reposts_of_me"
    ...
    def test_get_users_by_username_exists(self):
        ...
        assert method is not None, f"Method get_users_by_username does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_by_username should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_by_username"
    ...
    def test_get_users_muting_exists(self):
        ...
        assert method is not None, f"Method get_users_muting does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_users_muting should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_users_muting"
    ...
    def test_unblock_users_dms_exists(self):
        ...
        assert method is not None, f"Method unblock_users_dms does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"unblock_users_dms should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from unblock_users_dms"
    ...
    def test_no_unexpected_public_methods(self):
        ...
        actual_methods = set([name for name in dir(UsersClient) 
                            if not name.startswith('_') and callable(getattr(UsersClient, name))])
        ...
        if unexpected_methods:
            print(f"Warning: Unexpected methods found on UsersClient: {unexpected_methods}")
