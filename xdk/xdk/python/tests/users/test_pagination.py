...
class TestUsersPagination:
    ...
    # DEBUG: Processing pagination test for getPostsLikingUsers
    ...
    # DEBUG: Processing pagination test for getPostsRepostedBy
    # DEBUG: Required params count: 1
    ...
    # DEBUG: Processing pagination test for searchUsers
    # DEBUG: Required params count: 1
    
    # DEBUG: Found required param: query, type: reference, location: query
    ...
    def test_search_users_pagination_parameters(self):
        ...
        with patch.object(self.client, 'session') as mock_session:
            ...
            if second_call_args and len(second_call_args) > 1 and 'params' in second_call_args[1]:
                second_params = second_call_args[1]['params']
                assert "next_token" in second_params, \
                    "Second request should include next_token"
                assert second_params["next_token"] == "next_token_value", \
                    "Pagination token should be passed correctly"
    ...
    # DEBUG: Processing pagination test for getUsersBlocking
    # DEBUG: Required params count: 1
    ...
    # DEBUG: Processing pagination test for getUsersFollowing
    # DEBUG: Required params count: 1
    ...
    # DEBUG: Processing pagination test for getListsFollowers
    # DEBUG: Required params count: 1
    ...
    # DEBUG: Processing pagination test for getListsMembers
    # DEBUG: Required params count: 1
    ...
    # DEBUG: Processing pagination test for getUsersFollowers
    # DEBUG: Required params count: 1
    ...
    # DEBUG: Processing pagination test for getUsersRepostsOfMe
    ...
    # DEBUG: Processing pagination test for getUsersMuting
    # DEBUG: Required params count: 1
