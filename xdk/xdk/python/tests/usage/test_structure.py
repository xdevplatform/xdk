...
class TestUsageStructure:
    ...
    def test_get_usage_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_usage"
    ...
    def test_all_expected_methods_exist(self):
        ...
        client_methods = [name for name in dir(UsageClient) 
    ...
    def test_no_unexpected_public_methods(self):
        ...
        actual_methods = set([name for name in dir(UsageClient) 
                            if not name.startswith('_') and callable(getattr(UsageClient, name))])
        ...
        if unexpected_methods:
            print(f"Warning: Unexpected methods found on UsageClient: {unexpected_methods}")
