...
class TestComplianceStructure:
    ...
    def test_get_compliance_jobs_exists(self):
        ...
        assert method is not None, f"Method get_compliance_jobs does not exist on ComplianceClient"
        ...
        assert len(params) >= 1, f"get_compliance_jobs should have at least 'self' parameter"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_compliance_jobs"
    ...
    def test_create_compliance_jobs_exists(self):
        ...
        assert method is not None, f"Method create_compliance_jobs does not exist on ComplianceClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"create_compliance_jobs should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from create_compliance_jobs"
    ...
    def test_stream_labels_compliance_exists(self):
        ...
        assert method is not None, f"Method stream_labels_compliance does not exist on ComplianceClient"
    ...
    def test_get_compliance_jobs_by_id_exists(self):
        ...
        assert method is not None, f"Method get_compliance_jobs_by_id does not exist on ComplianceClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_compliance_jobs_by_id should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_compliance_jobs_by_id"
    ...
    def test_stream_posts_compliance_exists(self):
        ...
        assert method is not None, f"Method stream_posts_compliance does not exist on ComplianceClient"
    ...
    def test_stream_likes_compliance_exists(self):
        ...
        assert method is not None, f"Method stream_likes_compliance does not exist on ComplianceClient"
    ...
    def test_stream_users_compliance_exists(self):
        ...
        assert method is not None, f"Method stream_users_compliance does not exist on ComplianceClient"
    ...
    def test_all_expected_methods_exist(self):
        ...
        client_methods = [name for name in dir(ComplianceClient) 
    ...
    def test_no_unexpected_public_methods(self):
        ...
        actual_methods = set([name for name in dir(ComplianceClient) 
                            if not name.startswith('_') and callable(getattr(ComplianceClient, name))])
        ...
        if unexpected_methods:
            print(f"Warning: Unexpected methods found on ComplianceClient: {unexpected_methods}")
