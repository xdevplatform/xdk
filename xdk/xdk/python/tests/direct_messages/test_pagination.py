...
class TestDirectMessagesPagination:
    ...
    # DEBUG: Processing pagination test for getDmEventsByParticipantId
    # DEBUG: Required params count: 1
    
    # DEBUG: Found required param: participant_id, type: reference, location: path
    ...
    def test_get_dm_events_by_participant_id_cursor_creation(self):
        """Test that get_dm_events_by_participant_id can be used with Cursor."""
    ...
    def test_get_dm_events_by_participant_id_cursor_pages(self):
        """Test pagination with pages() for get_dm_events_by_participant_id."""
    ...
    def test_get_dm_events_by_participant_id_cursor_items(self):
    ...
    def test_get_dm_events_by_participant_id_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for get_dm_events_by_participant_id."""
    ...
    # DEBUG: Processing pagination test for getDmEvents
    ...
    # DEBUG: Processing pagination test for getDmConversationsIdDmEvents
    # DEBUG: Required params count: 1
    ...
    def test_get_dm_conversations_id_dm_events_cursor_creation(self):
        """Test that get_dm_conversations_id_dm_events can be used with Cursor."""
        method = getattr(self.direct_messages_client, "get_dm_conversations_id_dm_events")
        ...
        try:
            ...
            pytest.fail(f"Method getDmConversationsIdDmEvents should support pagination")
    
    def test_get_dm_conversations_id_dm_events_cursor_pages(self):
        """Test pagination with pages() for get_dm_conversations_id_dm_events."""
    ...
    def test_get_dm_conversations_id_dm_events_cursor_items(self):
        """Test pagination with items() for get_dm_conversations_id_dm_events."""
    ...
    def test_get_dm_conversations_id_dm_events_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for get_dm_conversations_id_dm_events."""
