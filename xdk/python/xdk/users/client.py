...
class UsersClient:
    ...
    def search(self, query: Any, max_results: int = None, next_token: Any = None) -> SearchResponse:
        """
        Search Users
    ...
    def get_posts(self, id: Any, since_id: Any = None, until_id: Any = None, max_results: int = None, pagination_token: Any = None, exclude: List = None, start_time: str = None, end_time: str = None) -> GetPostsResponse:
        """
        Get Posts
    ...
    def get_bookmarks(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetBookmarksResponse:
        """
        Get Bookmarks
    ...
    def get_mentions(self, id: Any, since_id: Any = None, until_id: Any = None, max_results: int = None, pagination_token: Any = None, start_time: str = None, end_time: str = None) -> GetMentionsResponse:
        """
        Get mentions
    ...
    def get_owned_lists(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetOwnedListsResponse:
        """
        Get owned Lists
    ...
    def get_followed_lists(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetFollowedListsResponse:
        """
        Get followed Lists
    ...
    def get_timeline(self, id: Any, since_id: Any = None, until_id: Any = None, max_results: int = None, pagination_token: Any = None, exclude: List = None, start_time: str = None, end_time: str = None) -> GetTimelineResponse:
        """
        Get Timeline
    ...
    def get_list_memberships(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetListMembershipsResponse:
        """
    ...
    def get_blocking(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetBlockingResponse:
        """
        Get blocking
    ...
    def get_followers(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetFollowersResponse:
        """
        Get followers
    ...
    def get_following(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetFollowingResponse:
        """
        Get following
    ...
    def get_reposts_of_me(self, max_results: int = None, pagination_token: Any = None) -> GetRepostsOfMeResponse:
        """
        Get Reposts of me
    ...
    def get_liked_posts(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetLikedPostsResponse:
        """
        Get liked Posts
    ...
    def get_muting(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetMutingResponse:
        """
        Get muting
