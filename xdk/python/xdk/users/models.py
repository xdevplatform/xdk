...
class GetByUsernameResponse(BaseModel):
    ...
    data: Optional["GetByUsernameResponseData"] =Field(description="The X User object.",default_factory=dict)
    errors: Optional[List] =None
...
class GetByIdResponse(BaseModel):
    ...
    data: Optional["GetByIdResponseData"] =Field(description="The X User object.",default_factory=dict)
    errors: Optional[List] =None
...
class GetMeResponse(BaseModel):
    ...
    data: Optional["GetMeResponseData"] =Field(description="The X User object.",default_factory=dict)
    errors: Optional[List] =None
