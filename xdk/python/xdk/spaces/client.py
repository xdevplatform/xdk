...
class SpacesClient:
    ...
    def search(self, query: str, state: str = None, max_results: int = None) -> SearchResponse:
        """
        Search Spaces
    ...
    def get_buyers(self, id: str, pagination_token: Any = None, max_results: int = None) -> GetBuyersResponse:
        """
