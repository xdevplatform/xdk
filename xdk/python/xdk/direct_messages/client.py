...
class DirectMessagesClient:
    ...
    def create_conversation(self, body: Optional[CreateConversationRequest] = None) -> Dict[str, Any]:
        """
    ...
    def get_events_by_conversation_id(self, id: Any, max_results: int = None, pagination_token: Any = None, event_types: List = None) -> GetEventsByConversationIdResponse:
        """
    ...
    def get_events_by_participant_id(self, participant_id: Any, max_results: int = None, pagination_token: Any = None, event_types: List = None) -> GetEventsByParticipantIdResponse:
        """
        Get DM events for a DM conversation
    ...
    def get_events(self, max_results: int = None, pagination_token: Any = None, event_types: List = None) -> GetEventsResponse:
        """
        Get DM events
