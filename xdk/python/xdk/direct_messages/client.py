...
class DirectMessagesClient:
    ...
    def get_events_by_id(self, event_id: Any, dm_eventfields: List = None, expansions: List = None, mediafields: List = None, userfields: List = None, tweetfields: List = None) -> GetEventsByIdResponse:
        """
        Get DM event by ID
