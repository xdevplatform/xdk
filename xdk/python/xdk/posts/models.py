"""
posts models for the X API.

This module provides models for the posts endpoints of the X API.
"""
...
class CreateRequest(BaseModel):
    ...
    media: Optional["CreateRequestMedia"] = Field(
