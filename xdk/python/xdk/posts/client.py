...
class PostsClient:
    ...
    def get_reposted_by(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetRepostedByResponse:
        """
        Get Reposted by
    ...
    def get_counts_recent(self, query: str, start_time: str = None, end_time: str = None, since_id: Any = None, until_id: Any = None, next_token: Any = None, pagination_token: Any = None, granularity: str = None) -> GetCountsRecentResponse:
        """
    ...
    def get_analytics(self, ids: List, end_time: str, start_time: str, granularity: str) -> GetAnalyticsResponse:
        """
        Get Post analytics
    ...
    def get_insights_historical(self, tweet_ids: List, end_time: str, start_time: str, granularity: str, requested_metrics: List) -> GetInsightsHistoricalResponse:
        """
    ...
    def search_recent(self, query: str, start_time: str = None, end_time: str = None, since_id: Any = None, until_id: Any = None, max_results: int = None, next_token: Any = None, pagination_token: Any = None, sort_order: str = None) -> SearchRecentResponse:
        """
        Search recent Posts
    ...
    def get_insights28hr(self, tweet_ids: List, granularity: str, requested_metrics: List) -> GetInsights28hrResponse:
        """
    ...
    def get_counts_all(self, query: str, start_time: str = None, end_time: str = None, since_id: Any = None, until_id: Any = None, next_token: Any = None, pagination_token: Any = None, granularity: str = None) -> GetCountsAllResponse:
        """
    ...
    def get_quoted(self, id: Any, max_results: int = None, pagination_token: Any = None, exclude: List = None) -> GetQuotedResponse:
        """
        Get Quoted Posts
    ...
    def get_liking_users(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetLikingUsersResponse:
        """
        Get Liking Users
    ...
    def search_all(self, query: str, start_time: str = None, end_time: str = None, since_id: Any = None, until_id: Any = None, max_results: int = None, next_token: Any = None, pagination_token: Any = None, sort_order: str = None) -> SearchAllResponse:
        """
        Search all Posts
    ...
    def get_reposts(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetRepostsResponse:
        """
        Get Reposts
