...
class ListsClient:
    ...
    def get_members(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetMembersResponse:
        """
        Get List members
    ...
    def get_posts(self, id: Any, max_results: int = None, pagination_token: Any = None) -> GetPostsResponse:
        """
        Get List Posts
