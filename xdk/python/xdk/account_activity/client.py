...
class AccountActivityClient:
    ...
    def get_subscription_count(self, ) -> GetSubscriptionCountResponse:
        """
    ...
    def create_subscription(self, webhook_id: Any, body: Optional[CreateSubscriptionRequest] = None) -> CreateSubscriptionResponse:
        """
        Create subscription
    ...
    def create_replay_job(self, webhook_id: Any, from_date: str, to_date: str) -> CreateReplayJobResponse:
        """
        Create replay job
    ...
    def delete_subscription(self, webhook_id: Any, user_id: Any) -> DeleteSubscriptionResponse:
        """
        Delete subscription
