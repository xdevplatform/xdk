...
class WebhooksClient:
    ...
    def create_stream_link(self, webhook_id: Any, tweetfields: str = None, expansions: str = None, mediafields: str = None, pollfields: str = None, userfields: str = None, placefields: str = None) -> CreateStreamLinkResponse:
        """
        Create stream link
