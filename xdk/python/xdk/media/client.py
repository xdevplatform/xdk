...
class MediaClient:
    ...
    def create_subtitles(self, body: Optional[CreateSubtitlesRequest] = None) -> CreateSubtitlesResponse:
        """
    ...
    def delete_subtitles(self, body: Optional[DeleteSubtitlesRequest] = None) -> DeleteSubtitlesResponse:
        """
    ...
    def append_upload(self, id: Any, body: Optional[AppendUploadRequest] = None) -> AppendUploadResponse:
        """
        Append Media upload
    ...
    def get_analytics(self, media_keys: List, end_time: str, start_time: str, granularity: str) -> GetAnalyticsResponse:
        """
        Get Media analytics
