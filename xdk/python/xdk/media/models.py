...
class CreateMetadataRequestMetadata(BaseModel):
    ...
    allow_download_status: Optional["CreateMetadataRequestMetadataAllowDownloadStatus"] = None
    ...
    content_expiration: Optional["CreateMetadataRequestMetadataContentExpiration"] = None
    domain_restrictions: Optional["CreateMetadataRequestMetadataDomainRestrictions"] = None
    ...
    sensitive_media_warning: Optional["CreateMetadataRequestMetadataSensitiveMediaWarning"] = None
...
class CreateMetadataResponseDataAssociatedMetadata(BaseModel):
    ...
    allow_download_status: Optional["CreateMetadataResponseDataAssociatedMetadataAllowDownloadStatus"] = None
    alt_text: Optional["CreateMetadataResponseDataAssociatedMetadataAltText"] = None
    audience_policy: Optional["CreateMetadataResponseDataAssociatedMetadataAudiencePolicy"] = None
    content_expiration: Optional["CreateMetadataResponseDataAssociatedMetadataContentExpiration"] = None
    domain_restrictions: Optional["CreateMetadataResponseDataAssociatedMetadataDomainRestrictions"] = None
    found_media_origin: Optional["CreateMetadataResponseDataAssociatedMetadataFoundMediaOrigin"] = None
    geo_restrictions:Any =None
    management_info: Optional["CreateMetadataResponseDataAssociatedMetadataManagementInfo"] = None
    preview_image: Optional["CreateMetadataResponseDataAssociatedMetadataPreviewImage"] = None
    sensitive_media_warning: Optional["CreateMetadataResponseDataAssociatedMetadataSensitiveMediaWarning"] = None
    shared_info: Optional["CreateMetadataResponseDataAssociatedMetadataSharedInfo"] = None
    sticker_info: Optional["CreateMetadataResponseDataAssociatedMetadataStickerInfo"] = None
    upload_source: Optional["CreateMetadataResponseDataAssociatedMetadataUploadSource"] = None
...
class CreateMetadataResponseDataAssociatedMetadataPreviewImage(BaseModel):
    ...
    media_key: Optional["CreateMetadataResponseDataAssociatedMetadataPreviewImageMediaKey"] = None
