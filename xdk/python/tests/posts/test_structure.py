...
class TestPostsStructure:
    ...
    def test_like_post_exists(self):
        ...
        # Check method exists
        method = getattr(PostsClient, "like_post", None)
        assert method is not None, f"Method like_post does not exist on PostsClient"
        # Check method is callable
    ...
    def test_like_post_return_annotation(self):
        ...
        method = getattr(PostsClient, "like_post")
        sig = inspect.signature(method)
        # Check return annotation exists
        assert (
            sig.return_annotation is not inspect.Signature.empty
    ...
    def test_unlike_post_exists(self):
        ...
        # Check method exists
        method = getattr(PostsClient, "unlike_post", None)
        assert method is not None, f"Method unlike_post does not exist on PostsClient"
        # Check method is callable
    ...
    def test_unlike_post_return_annotation(self):
        ...
        method = getattr(PostsClient, "unlike_post")
        sig = inspect.signature(method)
        # Check return annotation exists
        assert (
            sig.return_annotation is not inspect.Signature.empty
