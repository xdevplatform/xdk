...
class TestConnectionsStructure:
    ...
    def test_delete_all_exists(self):
        ...
        assert method is not None, f"Method delete_all does not exist on ConnectionsClient"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from delete_all"
    ...
    def test_all_expected_methods_exist(self):
        ...
        for expected_method in expected_methods:
            assert hasattr(ConnectionsClient, expected_method), \
                f"Expected method '{expected_method}' not found on ConnectionsClient"
            assert callable(getattr(ConnectionsClient, expected_method)), \
