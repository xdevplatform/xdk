...
class TestComplianceStructure:
    ...
    def test_get_jobs_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_jobs"
    ...
    def test_create_jobs_exists(self):
        ...
        assert method is not None, f"Method create_jobs does not exist on ComplianceClient"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from create_jobs"
    ...
    def test_get_jobs_by_id_exists(self):
        ...
        assert method is not None, f"Method get_jobs_by_id does not exist on ComplianceClient"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_jobs_by_id"
    ...
    def test_all_expected_methods_exist(self):
        ...
        for expected_method in expected_methods:
            assert hasattr(ComplianceClient, expected_method), \
                f"Expected method '{expected_method}' not found on ComplianceClient"
            assert callable(getattr(ComplianceClient, expected_method)), \
