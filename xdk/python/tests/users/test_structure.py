...
class TestUsersStructure:
    ...
    def test_get_liked_posts_exists(self):
        ...
        assert method is not None, f"Method get_liked_posts does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_liked_posts should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_liked_posts"
    ...
    def test_get_bookmarks_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_bookmarks"
    ...
    def test_create_bookmark_exists(self):
        ...
        assert method is not None, f"Method create_bookmark does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"create_bookmark should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from create_bookmark"
    ...
    def test_get_posts_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_posts"
    ...
    def test_get_owned_lists_exists(self):
        ...
        assert method is not None, f"Method get_owned_lists does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_owned_lists should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_owned_lists"
    ...
    def test_get_by_usernames_exists(self):
        ...
        assert method is not None, f"Method get_by_usernames does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_by_usernames should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_by_usernames"
    ...
    def test_get_reposts_of_me_exists(self):
        ...
        assert method is not None, f"Method get_reposts_of_me does not exist on UsersClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_reposts_of_me should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_reposts_of_me"
    ...
    def test_all_expected_methods_exist(self):
        ...
        for expected_method in expected_methods:
            assert hasattr(UsersClient, expected_method), \
                f"Expected method '{expected_method}' not found on UsersClient"
            assert callable(getattr(UsersClient, expected_method)), \
