...
class TestMediaStructure:
    ...
    def test_get_by_keys_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_by_keys"
    ...
    def test_finalize_upload_exists(self):
        ...
        assert method is not None, f"Method finalize_upload does not exist on MediaClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"finalize_upload should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from finalize_upload"
    ...
    def test_create_metadata_exists(self):
        ...
        assert method is not None, f"Method create_metadata does not exist on MediaClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"create_metadata should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from create_metadata"
    ...
    def test_initialize_upload_exists(self):
        ...
        assert method is not None, f"Method initialize_upload does not exist on MediaClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"initialize_upload should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from initialize_upload"
    ...
    def test_create_subtitles_exists(self):
        ...
        assert method is not None, f"Method create_subtitles does not exist on MediaClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"create_subtitles should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from create_subtitles"
    ...
    def test_delete_subtitles_exists(self):
        ...
        assert method is not None, f"Method delete_subtitles does not exist on MediaClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"delete_subtitles should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from delete_subtitles"
    ...
    def test_append_upload_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from append_upload"
    ...
    def test_get_by_key_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_by_key"
    ...
    def test_get_upload_status_exists(self):
        ...
        assert method is not None, f"Method get_upload_status does not exist on MediaClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_upload_status should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_upload_status"
    ...
    def test_upload_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from upload"
    ...
    def test_all_expected_methods_exist(self):
        ...
        for expected_method in expected_methods:
            assert hasattr(MediaClient, expected_method), \
                f"Expected method '{expected_method}' not found on MediaClient"
            assert callable(getattr(MediaClient, expected_method)), \
