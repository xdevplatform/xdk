...
class TestDirectMessagesPagination:
    ...
    def test_get_events_by_participant_id_cursor_creation(self):
        ...
        try:
            ...
            pytest.fail(f"Method get_events_by_participant_id should support pagination")
    ...
    def test_get_events_by_conversation_id_cursor_creation(self):
        ...
        try:
            ...
            pytest.fail(f"Method get_events_by_conversation_id should support pagination")
