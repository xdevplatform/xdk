...
class TestStreamStructure:
    ...
    def test_stream_likes_firehose_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_likes_firehose does not exist on StreamClient"
    ...
    def test_stream_posts_firehose_pt_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_posts_firehose_pt does not exist on StreamClient"
    ...
    def test_stream_posts_firehose_en_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_posts_firehose_en does not exist on StreamClient"
    ...
    def test_stream_posts_firehose_ja_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_posts_firehose_ja does not exist on StreamClient"
    ...
    def test_stream_posts_compliance_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_posts_compliance does not exist on StreamClient"
    ...
    def test_stream_likes_compliance_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_likes_compliance does not exist on StreamClient"
    ...
    def test_stream_likes_sample10_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_likes_sample10 does not exist on StreamClient"
    ...
    def test_stream_labels_compliance_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_labels_compliance does not exist on StreamClient"
    ...
    def test_stream_posts_sample_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_posts_sample does not exist on StreamClient"
    ...
    def test_stream_users_compliance_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_users_compliance does not exist on StreamClient"
    ...
    def test_stream_posts_firehose_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_posts_firehose does not exist on StreamClient"
    ...
    def test_stream_posts_firehose_ko_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_posts_firehose_ko does not exist on StreamClient"
    ...
    def test_stream_posts_sample10_exists(self):
        ...
        assert (
            method is not None
        ), f"Method stream_posts_sample10 does not exist on StreamClient"
    ...
    def test_no_unexpected_public_methods(self):
        ...
        if unexpected_methods:
            print(
                f"Warning: Unexpected methods found on StreamClient: {unexpected_methods}"
            )
