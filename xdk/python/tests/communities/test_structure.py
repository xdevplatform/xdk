...
class TestCommunitiesStructure:
    ...
    def test_get_by_id_exists(self):
        ...
        assert method is not None, f"Method get_by_id does not exist on CommunitiesClient"
    ...
    def test_all_expected_methods_exist(self):
        ...
        for expected_method in expected_methods:
            assert hasattr(CommunitiesClient, expected_method), \
                f"Expected method '{expected_method}' not found on CommunitiesClient"
            assert callable(getattr(CommunitiesClient, expected_method)), \
