...
class TestWebhooksStructure:
    ...
    def test_validate_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from validate"
    ...
    def test_create_stream_link_exists(self):
        ...
        assert method is not None, f"Method create_stream_link does not exist on WebhooksClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"create_stream_link should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from create_stream_link"
    ...
    def test_delete_stream_link_exists(self):
        ...
        assert method is not None, f"Method delete_stream_link does not exist on WebhooksClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"delete_stream_link should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from delete_stream_link"
    ...
    def test_get_exists(self):
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get"
    ...
    def test_get_stream_links_exists(self):
        ...
        assert method is not None, f"Method get_stream_links does not exist on WebhooksClient"
        ...
        # Should have 'self' as first parameter
        assert len(params) >= 1, f"get_stream_links should have at least 'self' parameter"
        assert params[0] == 'self', f"First parameter should be 'self', got '{params[0]}'"
        ...
        for required_param in required_params:
            assert required_param in params, f"Required parameter '{required_param}' missing from get_stream_links"
    ...
    def test_all_expected_methods_exist(self):
        ...
        for expected_method in expected_methods:
            assert hasattr(WebhooksClient, expected_method), \
                f"Expected method '{expected_method}' not found on WebhooksClient"
            assert callable(getattr(WebhooksClient, expected_method)), \
