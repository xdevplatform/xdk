...
class TestCommunityNotesContracts:
    ...
    def test_create_notes_request_structure(self):
        """Test create_notes request structure."""
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            from xdk.community_notes.models import CreateNotesRequest
            # Create instance with minimal valid data (empty instance should work for most cases)
            kwargs["body"] = CreateNotesRequest()
            # Call the method
            try:
                ...
                pytest.fail(f"Contract test failed for create_notes: {e}")


    def test_create_notes_required_parameters(self):
        """Test that create_notes handles parameters correctly."""
        method = getattr(self.community_notes_client, "create_notes")
    ...
    def test_create_notes_response_structure(self):
        """Test create_notes response structure validation."""
        with patch.object(self.client, "session") as mock_session:
    ...
    def test_delete_notes_request_structure(self):
        """Test delete_notes request structure."""
        # Mock the session to capture request details
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            ...
            try:
                ...
                pytest.fail(f"Contract test failed for delete_notes: {e}")


    def test_delete_notes_required_parameters(self):
        """Test that delete_notes handles parameters correctly."""
        method = getattr(self.community_notes_client, "delete_notes")
        # Test with missing required parameters - mock the request to avoid network calls
        with patch.object(self.client, "session") as mock_session:
            # Mock a 400 response (typical for missing required parameters)
    ...
    def test_delete_notes_response_structure(self):
        """Test delete_notes response structure validation."""
        with patch.object(self.client, "session") as mock_session:
            # Create mock response with expected structure
            mock_response_data = {
                "data": None,
    ...
    def test_search_notes_written_request_structure(self):
        """Test search_notes_written request structure."""
        # Mock the session to capture request details
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            ...
            try:
                ...
                pytest.fail(f"Contract test failed for search_notes_written: {e}")


    def test_search_notes_written_required_parameters(self):
        """Test that search_notes_written handles parameters correctly."""
        method = getattr(self.community_notes_client, "search_notes_written")
        # Test with missing required parameters - mock the request to avoid network calls
        with patch.object(self.client, "session") as mock_session:
            # Mock a 400 response (typical for missing required parameters)
    ...
    def test_search_notes_written_response_structure(self):
        """Test search_notes_written response structure validation."""
        with patch.object(self.client, "session") as mock_session:
            # Create mock response with expected structure
            mock_response_data = {
                "data": None,
    ...
    def test_search_for_eligible_posts_request_structure(self):
        """Test search_for_eligible_posts request structure."""
        # Mock the session to capture request details
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            ...
            try:
                ...
                pytest.fail(f"Contract test failed for search_for_eligible_posts: {e}")


    def test_search_for_eligible_posts_required_parameters(self):
        """Test that search_for_eligible_posts handles parameters correctly."""
    ...
    def test_search_for_eligible_posts_response_structure(self):
        """Test search_for_eligible_posts response structure validation."""
        with patch.object(self.client, "session") as mock_session:
            # Create mock response with expected structure
            mock_response_data = {
                "data": None,
