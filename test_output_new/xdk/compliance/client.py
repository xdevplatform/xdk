...
import requests
import time
from .models import 2_tweets_compliance_stream_response, 2_likes_compliance_stream_response, 2_compliance_jobs_id_response, 2_users_compliance_stream_response, 2_tweets_label_stream_response, 2_compliance_jobs_response, 2_compliance_jobs_request, 2_compliance_jobs_response
...
class ComplianceClient:
    ...
    def get_compliance_jobs_by_id(self, 
    ...
    def create_compliance_jobs(self, 
