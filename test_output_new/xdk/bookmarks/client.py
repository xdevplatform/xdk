...
import requests
import time
from .models import 2_users_id_bookmarks_response, 2_users_id_bookmarks_request, 2_users_id_bookmarks_response, 2_users_id_bookmarks_folders_folder_id_response, 2_users_id_bookmarks_tweet_id_response, 2_users_id_bookmarks_folders_response
...
class BookmarksClient:
    ...
    def get_users_bookmarks(self, 
        ...
        Returns:
            2_users_id_bookmarks_response: Response data
        """
        ...
        return 2_users_id_bookmarks_response.model_validate(response_data)
        
    
    def create_users_bookmark(self, 
        ...
        body: 2_users_id_bookmarks_request,
    ...
    def get_users_bookmarks_by_folder_id(self, 
    ...
    ) -> 2_users_id_bookmarks_folders_folder_id_response:
        """
        ...
        Returns:
            2_users_id_bookmarks_folders_folder_id_response: Response data
        """
        ...
        return 2_users_id_bookmarks_folders_folder_id_response.model_validate(response_data)
        
    
    def delete_users_bookmark(self, 
    ...
    ) -> 2_users_id_bookmarks_tweet_id_response:
        """
        Delete Bookmark
        ...
        Returns:
            2_users_id_bookmarks_tweet_id_response: Response data
        """
        ...
        return 2_users_id_bookmarks_tweet_id_response.model_validate(response_data)
        
    
    def get_users_bookmark_folders(self, 
    ...
    ) -> 2_users_id_bookmarks_folders_response:
        """
        ...
        Returns:
            2_users_id_bookmarks_folders_response: Response data
        """
        ...
        return 2_users_id_bookmarks_folders_response.model_validate(response_data)
