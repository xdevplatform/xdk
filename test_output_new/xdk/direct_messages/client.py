...
import requests
import time
from .models import 2_dm_conversations_id_dm_events_response, 2_dm_events_event_id_response, 2_dm_events_event_id_response, 2_dm_events_response, 2_dm_conversations_with_participant_id_dm_events_response, 2_dm_conversations_dm_conversation_id_messages_request, 2_dm_conversations_dm_conversation_id_messages_response, 2_dm_conversations_with_participant_id_messages_request, 2_dm_conversations_with_participant_id_messages_response, 2_dm_conversations_request, 2_dm_conversations_response
...
class Direct_MessagesClient:
    ...
    def get_dm_events_by_participant_id(self, 
    ...
    def create_dm_by_conversation_id(self, 
    ...
    def create_dm_by_participant_id(self, 
    ...
    def create_dm_conversations(self, 
