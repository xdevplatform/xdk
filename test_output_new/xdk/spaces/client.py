...
import requests
import time
from .models import 2_spaces_id_tweets_response, 2_spaces_id_buyers_response, 2_spaces_id_response, 2_spaces_response, 2_spaces_search_response, 2_spaces_by_creator_ids_response
...
class SpacesClient:
    ...
    def get_spaces_by_id(self, 
        ...
        Returns:
            2_spaces_id_response: Response data
        """
        ...
        return 2_spaces_id_response.model_validate(response_data)
        
    
    def get_spaces_by_ids(self, 
        ...
        Returns:
            2_spaces_response: Response data
        """
        ...
        return 2_spaces_response.model_validate(response_data)
    ...
    def search_spaces(self, 
        ...
        Returns:
            2_spaces_search_response: Response data
        """
        ...
        return 2_spaces_search_response.model_validate(response_data)
        
    
    def get_spaces_by_creator_ids(self, 
    ...
    ) -> 2_spaces_by_creator_ids_response:
        """
        ...
        Returns:
            2_spaces_by_creator_ids_response: Response data
        """
        ...
        return 2_spaces_by_creator_ids_response.model_validate(response_data)
