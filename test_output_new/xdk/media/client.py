...
import requests
import time
from .models import 2_media_analytics_response, 2_media_media_key_response, 2_media_response
...
class MediaClient:
    ...
    def get_media_by_media_key(self, 
    ...
    def get_media_by_media_keys(self, 
