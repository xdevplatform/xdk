...
import requests
import time
from .models import 2_tweets_id_retweets_response, 2_users_id_likes_request, 2_users_id_likes_response, 2_insights_28hr_response, 2_tweets_response, 2_tweets_request, 2_tweets_response, 2_users_id_liked_tweets_response, 2_tweets_id_quote_tweets_response, 2_tweets_search_stream_rules_response, 2_tweets_search_stream_rules_request, 2_tweets_search_stream_rules_response, 2_spaces_id_tweets_response, 2_tweets_search_all_response, 2_tweets_firehose_stream_lang_en_response, 2_tweets_id_response, 2_tweets_id_response, 2_spaces_id_buyers_response, 2_tweets_tweet_id_hidden_request, 2_tweets_tweet_id_hidden_response, 2_tweets_sample_stream_response, 2_tweets_search_recent_response, 2_tweets_firehose_stream_response, 2_tweets_search_stream_response, 2_users_id_mentions_response, 2_users_id_retweets_source_tweet_id_response, 2_insights_historical_response, 2_lists_id_tweets_response, 2_tweets_firehose_stream_lang_ja_response, 2_users_id_likes_tweet_id_response, 2_users_id_timelines_reverse_chronological_response, 2_users_id_tweets_response, 2_tweets_counts_all_response, 2_tweets_analytics_response, 2_tweets_counts_recent_response, 2_users_id_retweets_request, 2_users_id_retweets_response, 2_tweets_firehose_stream_lang_ko_response, 2_tweets_firehose_stream_lang_pt_response, 2_tweets_sample10_stream_response
...
class TweetsClient:
    ...
    def get_users_liked_posts(self, 
    ...
    def get_tweets_id_quote_tweets(self, 
    ...
    def get_insights_historical(self, 
    ...
    def get_posts_counts_recent(self, 
