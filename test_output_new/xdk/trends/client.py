...
import requests
import time
from .models import 2_trends_by_woeid_woeid_response, 2_users_personalized_trends_response
...
class TrendsClient:
    ...
    def get_users_personalized_trends(self, 
