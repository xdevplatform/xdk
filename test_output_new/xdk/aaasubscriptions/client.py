...
import requests
import time
from .models import 2_account_activity_webhooks_webhook_id_subscriptions_all_response, 2_account_activity_webhooks_webhook_id_subscriptions_all_request, 2_account_activity_webhooks_webhook_id_subscriptions_all_response, 2_account_activity_subscriptions_count_response, 2_account_activity_webhooks_webhook_id_subscriptions_all_list_response, 2_account_activity_replay_webhooks_webhook_id_subscriptions_all_response, 2_account_activity_webhooks_webhook_id_subscriptions_user_id_all_response
...
class AAASubscriptionsClient:
    ...
    def validate_account_activity_subscription(self, 
    ...
    def create_account_activity_subscription(self, 
    ...
    def get_account_activity_subscription_count(self, 
    ...
    def get_account_activity_subscriptions(self, 
    ...
    def create_account_activity_replay_job(self, 
    ...
    def delete_account_activity_subscription(self, 
